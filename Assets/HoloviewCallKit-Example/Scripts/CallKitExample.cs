...
public class CallKitExample : MonoBehaviour {
    ...
    void MP_OnCallConnect (string callId)
	{
        ...
        op.id = 0;
        Operations.Add(op);
        //vmh.transform.position = Vector3.zero;
        //Debug.Log("sssssssssssssssssssssssssssssssssssssss");

        // ProjectEntry.Instance.CallComplete();
    }
...
#else
        callid = HoloviewCallKit.instance().CallFull(ConversationType.P2P, targetId, inviteUsers, subUsers, true, TranslateMode.NONE, CallMediaType.VIDEO, true);
